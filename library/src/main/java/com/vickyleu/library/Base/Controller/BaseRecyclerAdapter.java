...
public abstract class BaseRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements OnItemCallBack<T>, OnViewClickListener<VH>, OnItemClickListener<T>, OnItemLongClickListener<T> {
    ...
    public BaseRecyclerAdapter(List<T> list, Context mContext) {
        this.list = list;
